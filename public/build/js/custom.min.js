...
function init_sidebar() {
  ...
  //   // if(     document.getElementById('navid').classList.contains('nav-md') ){

  //   //   document.getElementById('navid').classList.remove('nav-md')
  //   //   document.getElementById('navid').classList.add('nav-sm')
  //   // }else{
  //   //   document.getElementById('navid').classList.add('nav-md')
  //   //   document.getElementById('navid').classList.remove('nav-sm')
  //   // }
  //   // console.log('togle' ,document.getElementById('navid') )
...
function init_morris_charts() {
  ...
  if ($('#graph_line').length) {
    ...
    //   $(window).resize();
    //   console.log('on');
    //   console.log('togle2', document.getElementById('navid'));
    // });
  }
}
